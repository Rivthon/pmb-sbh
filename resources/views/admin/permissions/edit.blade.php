...
@include('admin_dashboard.components.page-hero', [
    ...
    'subtitle' => 'Perbarui pengenal sistem untuk hak akses terpilih.',
    'icon' => 'key',
        ...
        <div class="col-lg-6 col-md-8 col-12">
            <form id="permissionForm" action="{{ route('admin.permissions.update', $permission->id) }}" method="POST">
                ...
                @component('admin_dashboard.components.admin-card', [
                    ...
                    'icon' => 'bx bx-edit-alt text-primary',
                    'subtitle' => 'Sesuaikan nama pengenal sistem untuk hak akses terpilih.'
                ])
                    <div class="row g-3">
                        <div class="col-md-12">
