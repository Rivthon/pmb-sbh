...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold">Edit Tes Tulis</h4>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.tes-tulis.update', $tesTulis->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_tes" class="form-control"
                        value="{{ old('nama_tes', $tesTulis->nama_tes) }}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control"
                        rows="3">{{ old('deskripsi', $tesTulis->deskripsi) }}</textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="durasi_menit" class="form-control"
                            value="{{ old('durasi_menit', $tesTulis->durasi_menit) }}" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Skor Lulus</label>
                        <input type="number" name="skor_lulus" class="form-control"
                            value="{{ old('skor_lulus', $tesTulis->skor_lulus) }}" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label fw-bold">Status Aktif</label>
                        <select name="status_aktif" class="form-select">
                            <option value="1" {{ old('status_aktif', $tesTulis->status_aktif) == 1 ? 'selected' : ''
                                }}>Aktif</option>
                            <option value="0" {{ old('status_aktif', $tesTulis->status_aktif) == 0 ? 'selected' : ''
                                }}>Nonaktif</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="acak_soal" value="1" id="acakSoal" {{
                                old('acak_soal', $tesTulis->acak_soal) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="acak_pilihan" value="1"
                                id="acakPilihan" {{ old('acak_pilihan', $tesTulis->acak_pilihan) ? 'checked' : '' }}>
