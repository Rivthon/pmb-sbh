...
@include('admin_dashboard.components.page-hero', [
    ...
    'subtitle' => 'Buat akun pengguna sistem baru dengan hak akses dan role tertentu.',
    'icon' => 'user-plus',
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                @component('admin_dashboard.components.admin-card', [
                    ...
                    'subtitle' => 'Silakan lengkapi nama lengkap, email, dan password untuk akun baru.'
                ])
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <div class="admin-form-group">
                                ...
                                <select id="jurusan_id" name="jurusan_id" class="form-select @error('jurusan_id') is-invalid @enderror">
                                    ...
                                    @foreach($jurusans as $jurusan)
                                        <option value="{{ $jurusan->id }}" @selected((string) old('jurusan_id') === (string) $jurusan->id)>{{ $jurusan->nama_jurusan }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="admin-form-group">
                                ...
                                <div class="input-group input-group-merge admin-password-group">
                                    <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" required minlength="6" placeholder="Minimal 6 karakter">
                                    <button class="input-group-text admin-password-toggle" type="button" data-password-toggle="password" aria-label="Tampilkan password">
                        ...
                        <div class="col-md-6">
                            <div class="admin-form-group">
                                ...
                                <div class="input-group input-group-merge admin-password-group">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" required minlength="6" placeholder="Ulangi password">
                                    <button class="input-group-text admin-password-toggle" type="button" data-password-toggle="password_confirmation" aria-label="Tampilkan konfirmasi password">
            ...
            <div class="col-lg-4">
                @component('admin_dashboard.components.admin-card', [
                    ...
                    <div class="admin-form-group mb-0">
                        ...
                        @enderror
                        <small class="text-muted d-block mt-3">Akun baru wajib memiliki minimal satu role akses agar dapat menggunakan sistem.</small>
                    </div>
                @endcomponent
