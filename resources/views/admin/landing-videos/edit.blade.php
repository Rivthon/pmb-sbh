...
@section('title', 'Edit Video Shorts')
...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">
                    <i class='bx bx-edit text-primary me-2'></i>Edit Video Shorts
                </h4>
                <p class="text-muted mb-0">Perbarui informasi video YouTube Shorts pada landing page</p>
            </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <form action="{{ route('admin.landing-videos.update', $landingVideo->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="youtube_video_id" id="youtube_video_id" 
                                       value="{{ old('youtube_video_id', $landingVideo->youtube_video_id) }}" required 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title" value="{{ old('title', $landingVideo->title) }}" required 
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="sort_order" value="{{ old('sort_order', $landingVideo->sort_order) }}">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="form-check form-switch mt-md-4 pt-1">
                                        <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="is_active" value="1" {{ old('is_active', $landingVideo->is_active) ? 'checked' : '' }}>
