...
<section class="position-relative overflow-hidden py-5" style="min-height: 300px;">
    <img src="{{ asset('dashboard_assets/assets/img/front-pages/landing-page/header.png') }}" alt="Header Gizi"
    ...
    <div class="text-center text-white position-relative z-1" style="margin-top: 8rem;">
        <h1 class="display-4 fw-bold">Program Studi Sarjana Gizi</h1>
        <p class="lead mb-0 text-dark">Mencetak ahli gizi yang kompeten, inovatif, dan siap menghadapi tantangan kesehatan masyarakat</p>
    </div>
</section>
                ...
                <div class="card-body">
                    <div class="position-relative mb-4">
                        <div class="ratio ratio-16x9">
                            <iframe id="heroVideoGizi" class="embed-responsive-item"
                                src="https://www.youtube.com/embed/JKkfJVV4RHQ?start=280&enablejsapi=1&rel=0&autoplay=1&mute=1&controls=0&modestbranding=1"
